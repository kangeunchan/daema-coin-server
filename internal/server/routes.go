...
func (s *server) routes() http.Handler {
	...
	routes.customer("POST /api/customer/push-targets", s.handleCustomerPushTargetRegister)
	routes.customer("DELETE /api/customer/push-targets", s.handleCustomerPushTargetDelete)
	routes.customer("DELETE /api/customer/push-targets/{targetId}", s.handleCustomerPushTargetDelete)
	...
	routes.customer("GET /api/customer/favorites", s.handleFavorites)
